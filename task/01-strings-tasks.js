...
function getCardId(value) {
  ...
  let cardSuit = value.substr(-1);
  let multiplicity = 0;
  switch (cardSuit) {
    case "♦": multiplicity = 13; break;
    case "♥": multiplicity = 26; break;
    case "♠": multiplicity = 39; break;
    default: break;
  }
  let cardValue = Number(cardNumber);
  if (isNaN(cardValue)) {
    switch (cardNumber) {
  ...
  return multiplicity + cardValue - 1;
}
